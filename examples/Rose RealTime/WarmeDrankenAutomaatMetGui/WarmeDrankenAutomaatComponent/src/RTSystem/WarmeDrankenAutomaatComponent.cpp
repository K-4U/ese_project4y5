// {{{RME component 'Component View::WarmeDrankenAutomaatComponent'

#if defined( PRAGMA ) && ! defined( PRAGMA_IMPLEMENTED )
#pragma implementation "RTSystem/WarmeDrankenAutomaatComponent.h"
#endif
...
const char * const default_argv[] = { "AWarmeDrankenAutomaat" };
